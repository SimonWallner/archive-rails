Feature: Company fields
  ...
  Scenario: insert company with valid fields data
	...
	@javascript
  Scenario: fail to add a founding date with only a day given
    Given I am on the company creation page
    When I enter valid company data 
    And I enter only the day as the founding date
    And I submit it
    And I should see an error message

	@javascript
  Scenario: fail to add a founding date with only a day and month given
    Given I am on the company creation page
    When I enter valid company data 
    And I enter a only the day and month as the founding date
    And I submit it
    And I should see an error message
